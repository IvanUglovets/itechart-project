                ...
                <CardContent>
                    ...
                    <Box component="div" sx={{display: "flex", justifyContent: "center"}}>
                        <div>
                            ...
                            <div>
                                <Typography component="span" sx={{fontWeight: "bold"}}>Population: </Typography>
                                <Typography component="span">{country.population}</Typography>
                            </div>
                            <div>
                                <Typography component="span" sx={{fontWeight: "bold"}}>Region: </Typography>
                                <Typography component="span">{country.region}</Typography>
                            </div>
                            <div>
                                <Typography component="span" sx={{fontWeight: "bold"}}>Capital: </Typography>
